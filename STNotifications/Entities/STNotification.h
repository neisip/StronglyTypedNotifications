...
@interface STNotification<__covariant PayloadType>: NSObject <STNotificationNameProvider>
@property (nonatomic, weak, readonly) id __nullable sender;
@property (nonatomic, strong, readonly) PayloadType __nullable payload;
- (instancetype __nullable)initWithName:(NSNotificationName __nonnull )name payload:(id __nullable)payload sender:(id __nullable)sender NS_DESIGNATED_INITIALIZER;
